...
def load_data(city, month, day):
    ...
    if month == ('all','january', 'february', 'march', 'april', 'may', 'june'):
    ...
    if day == ('all','monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'):
...
def user_stats(df,city):
    ...
    #Check for birth year column
        ...
        # Display earliest, most recent, and most common year of birth
            ...
            print('Sorry: Data of Gender and birth not found for washington city')       
